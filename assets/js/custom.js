    ...
    target.find('input , textarea , select').each(function(){
        if($(this).hasClass('require')){
            if($(this).val().trim() == ''){
                ...
                targetResp.html('بعضی از زمینه ها را از دست داده اید.');
                $(this).addClass('error');
                return false;
            }else{
       ...
       var formDetail = new FormData(targetForm[0]);
        ...
        $.ajax({
            ...
            if(resp == 1){
                ...
                errroTarget.html('<p style="color:green;">نامه با موفقیت ارسال شد</p>');
            }else{
                errroTarget.html('<p style="color:red;">مشکلی پیش آمد لطفاً دوباره امتحان کنید.</p>');
            }
        });
    }
});